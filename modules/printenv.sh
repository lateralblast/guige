...
print_env () {
  ...
  handle_output "# OS name:                   [ISO_OSNAME]                     $ISO_OSNAME"         "TEXT"
  ...
  handle_output "# ISO mount directory:       [ISO_MOUNTDIR]                   $ISO_MOUNTDIR"                           "TEXT"
  if [ "$DO_ISO_OLDINSTALLER" = "true" ]; then
    handle_output "# Old ISO mount directory:   [OLD_ISO_MOUNTDIR]               $OLD_ISO_MOUNTDIR"            "TEXT"
    handle_output "# Old install squashfs file: [OLD_ISO_INSTALLSQUASHFSFILE]    $OLD_ISO_INSTALLSQUASHFSFILE" "TEXT"
  fi
